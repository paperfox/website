      ...
      <div className="container">
        ...
        <div className="row justify-content-center mt-3 mb-5">
          <div className="col-sm-10 col-md-6 col-lg-4">
            ...
            <div className="mb-5">
              <p>Paperfox is mainly the home of my evolving <a href="https://paperfox.github.io/tarot" target="_blank" rel="noreferrer">Tarot app</a>. As a developer professionally and an artist by passion it'd so rewarding to work on something that makes use of such a wide range of my skills. If I'm not poking away at this, I'm likely doodling up some of the card images, playing with my dog, or out in my garden.</p>
          ...
          <div className="col-sm-10 col-md-6 col-lg-4 paperfox-links">
            ...
            <ul className="list-unstyled">
              <li className="mb-4 w-100">
                <a href="https://paperfox.github.io/tarot" target="_blank" rel="noreferrer" className="p-4">
            ...
            <ul className="list-unstyled d-flex mb-0">
              <li className="mb-4 w-50">
                <a href="https://www.instagram.com/paperfoxmakesart/" target="_blank" rel="noreferrer" className="p-4">
                  <img src="https://paperfox.github.io/images/instagramlogo.svg" alt="" className="me-3" />
                  <span className="pt-1">Instagram</span>
                </a>
              </li>
              <li className="mb-4 w-50">
                <a href="https://cara.app/paperfox" target="_blank" rel="noreferrer" className="p-4">
                  <img src="https://paperfox.github.io/images/cara-app-logo-circle-White.svg" alt="" className="me-3" />
            ...
            <ul className="list-unstyled">
              <li className="mb-4 w-100">
                <a href="https://github.com/paperfox" target="_blank" rel="noreferrer" className="p-4">
                  <img src="https://paperfox.github.io/images/github-mark.svg" alt="" className="me-3" />
